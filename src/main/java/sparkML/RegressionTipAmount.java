...
public final class RegressionTipAmount {
    ...
    public static void main(final String[] args) throws InterruptedException {
        ...
        List<Document> sample = rdd.takeSample(false, 320000, 0);
        ...
        for (Document item : sample) {
            ...
            rowdata.add(RowFactory.create(tip_amount, Vectors.dense(trip_distance, tolls_amount,
                    length, r1, r2, r3, r4)));
        }
...
//////////////////////Test Data
        ...
        for (Document item : testSample) {
            ...
            rowdata2.add(RowFactory.create(tip_amount, Vectors.dense(trip_distance, tolls_amount,
                    length, r1, r2, r3, r4)));
        }
...
// Print the coefficients and intercept for linear regression.
        ...
        System.out.println("R squared testing, " + r2);
